            ...
            addGallery(Data) {
                ...
                $.each(obj, (function(i, item) {
                    for ("tiles" == self.galleryStyle && (className = "tiles"), "full" == self.galleryStyle && (className = "full"), "center" == self.galleryStyle && (className = "center"), "Circles" == self.galleryStyle && (className = "Circles"), "mosaic" == self.galleryStyle && (className = "mosaic"), "mosaic" != className ? $(".Gallery").append("<p>" + obj.Entry.Title + "</p>") : $(".Gallery").hide(), length = Object.keys(obj.Entry.Image).length, $(".addToGallery").each((function() {
                        ...
                        let x = 1;
                        if (x = obj.Entry.Image[i].includes(".jpeg#preview") ? 2 : obj.Entry.Image[i].includes(".jpg#preview") ? 2 : obj.Entry.Image[i].includes(".png#preview") ? 2 : obj.Entry.Image[i].includes(".webp#preview") ? 2 : 1, 1 == x) $(".Gallery").append('<img loading="lazy" class="' + className + '" alt="Image' + self.ImageIndex + '" width="300px" height="169px" class="fadein" id="' + self.ImageIndex + '" onClick="JavaScriptGallery.openViewer(this.id)" src="' + obj.Entry.Image[i] + '"/>'), self.ImageIndex++;
                        else {
                            let split, newURL;
                            obj.Entry.Image[i].includes(".jpeg") ? (split = obj.Entry.Image[i].split(".jpeg"), newURL = split[0] + "-preview.jpeg#preview") : obj.Entry.Image[i].includes(".jpg") ? (split = obj.Entry.Image[i].split(".jpg"), newURL = split[0] + "-preview.jpg#preview") : obj.Entry.Image[i].includes(".png") ? (split = obj.Entry.Image[i].split(".png"), newURL = split[0] + "-preview.png#preview") : obj.Entry.Image[i].includes(".webp") && (split = obj.Entry.Image[i].split(".webp"), newURL = split[0] + "-preview.webp#preview"), $(".Gallery").append('<img loading="lazy" class="' + className + '" alt="Image' + self.ImageIndex + '" width="300px" height="169px" class="fadein" id="' + self.ImageIndex + '" onClick="JavaScriptGallery.openViewer(this.id)" src="' + newURL + '"/>'), self.ImageIndex++
                        }
                    }
                })), this.addPlayer()
            }
...
<body>
    ...
    <form action=" ./" method="get" class="pis-bar-item">
        <div class="tooltip pis-bar-item">
            <input type="text" name="start_link" placeholder="Start Link" value="https://fapello.com/content/s/a/saizneko/1000/saizneko_0">
            <span class="tooltiptext">Start Link</span>
        </div>
        <div class="tooltip pis-bar-item">
            <input type="text" name="end_link" placeholder="End Link" value=".jpg">
            <span class="tooltiptext">End Link</span>
        </div>
        <div class="tooltip pis-bar-item">
            <input type="text" name="start_number" placeholder="Start Number" value="1">
            <span class="tooltiptext">Start Number</span>
        </div>
        <div class="tooltip pis-bar-item">
            <input type="text" name="end_number" placeholder="End Number" value="622">
